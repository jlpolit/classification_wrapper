...
class TestClasswrap(unittest.TestCase):
    ...
    def test_fit_predict_evaluate(self):
        logit_model = LogitWrapper()
        logit_model.fit(self.X_train, self.y_train, random_state=0)
        ...
        # to do: K folds
        k_folds_output = logit_model.tune_parameters(self.X_train, self.y_train, random_state=0)
    ...
    def test_new_category(self):
        ...
        logit_model3.fit(X_fewer_factor_levels, self.y_train, random_state=0)
